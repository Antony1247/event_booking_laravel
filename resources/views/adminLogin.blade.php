...
<div style="width: 1440px; height: 900px; position: relative; background: #F8F8FA; border-radius: 20px; overflow: hidden">
    ...
    <div style="width: 412px; height: 197px; left: 934px; top: 350px; position: absolute">
      ...
      <div style="left: 0px; top: 89px; position: absolute; text-align: center; color: white; font-size: 16px; font-family: Product Sans; font-weight: 400; word-wrap: break-word">Craft Your Vision, Host Your Event: Seamlessly Create, Effortlessly Manage!</div>
      ...
      <button type="submit" onclick="window.location.href='/adminregister'" style="width: 128px; height: 49px; padding-left: 40px; padding-right: 40px; padding-top: 15px; padding-bottom: 15px; left: 145px; top: 148px; position: absolute; background: #d2d1d4; border-radius: 5px; justify-content: center; align-items: center; gap: 10px; display: inline-flex">Sign Up</button>
    </div>
  </div>
</form>
</body>
